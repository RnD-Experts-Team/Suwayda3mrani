...
document.addEventListener('DOMContentLoaded', function() {
    ...
    keyInput.addEventListener('input', function() {
        ...
        if (key.includes('.')) {
            ...
            // Check if the suggested group exists in the dropdown
            const groupOption = groupSelect.querySelector(`option[value="${suggestedGroup}"]`);
            if (groupOption) {
                groupSelect.value = suggestedGroup;
            }
        }
    });
});

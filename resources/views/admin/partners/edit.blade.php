                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('logo_url') is-invalid @enderror" 
                               name="logo_url" value="{{ old('logo_url', $partner->logo_url) }}" required>
                        @error('logo_url')
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="sort_order" value="{{ old('sort_order', $partner->sort_order) }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="is_active" name="is_active" {{ old('is_active', $partner->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="p-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name_{{ $language->code }}" 
                                       value="{{ old('name_' . $language->code, $partner->{'name_' . $language->code}) }}" required>
                            </div>
                        </div>
                    </div>
                @endforeach

...
@section('page-title', 'Add New Story')
                    ...
                    <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}" id="{{ $language->code }}" role="tabpanel">
                        <div class="p-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control summernote" name="content_{{ $language->code }}" rows="10" required>{{ old('content_' . $language->code) }}</textarea>
                            </div>
                        </div>
                    </div>
                @endforeach
